...
public class JFrameDesasignarDepartamentoTienda extends JFrame
{
	...
	public JFrameDesasignarDepartamentoTienda() 
	{
		this.setTitle("Desasignar departamento a tienda");
	...
	public class ActionListenerAltaCliente implements ActionListener 
	{
		...
		public void actionPerformed(ActionEvent arg0)
		{
			try 
			{
				Controlador.getInstance().accion(ListaComandos.NEGOCIODESASIGNARDEPARTAMENTOTIENDA, new TransferPresupuesto(Integer.parseInt(departamento.getText()), Integer.parseInt(tienda.getText()), true));
			} 
