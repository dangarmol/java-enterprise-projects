...
public class JFrameListaDepartamento extends JFrame 
{
	...
	public JFrameListaDepartamento() 
	{
		this.setTitle("Lista departamento");
	...
	public class ActionListenerListaCliente implements ActionListener 
	{
		...
		public void actionPerformed(ActionEvent arg0) 
		{	
			Controlador.getInstance().accion(ListaComandos.NEGOCIOLISTADEPARTAMENTO, null);
		}
	}
