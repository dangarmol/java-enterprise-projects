...
public class JFrameDetalleDepartamento extends JFrame
{
	...
	public JFrameDetalleDepartamento() 
	{
		this.setTitle("Detalle departamento");
	...
	public class ActionListenerDetalleCliente implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent arg0) 
		{
			try 
			{
				Controlador.getInstance().accion(ListaComandos.NEGOCIODETALLEDEPARTAMENTO, Integer.parseInt(id.getText()));
			} 
