...
public class JFrameModificarTienda extends JFrame
{
	...
	public class ActionListenerModificarCliente implements ActionListener 
	{
		...
		public void actionPerformed(ActionEvent arg0)
		{
			try 
			{
				Controlador.getInstance().accion(ListaComandos.NEGOCIOMODIFICARTIENDA, new TransferTienda(Integer.parseInt(id.getText()), nombre.getText(), direccion.getText(), true));
			} 
